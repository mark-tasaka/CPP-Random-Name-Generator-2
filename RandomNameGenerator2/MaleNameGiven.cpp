...
string* MaleNameGiven::armenianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Nishan", "Ohanna", "Vahe", "Vartan", "Yervant"
    };
...
string* MaleNameGiven::celticGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Afton", "Ahearn", "Annan", "Fallon", "Finley", "Kearney", "Keary", "Kegan", "Keir", "Kendall", "Mannix", "Marmaduke", "Melvin", "Merlin", "Murray", "Perth", "Ronan", "Sean", "Tadc", "Tegan", "Tiernan", "Torin", "Tuathal", "Ultan", "Vaughan"
    };
...
string* MaleNameGiven::chineseGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "An", "Bing", "Chen", "Chung", "Confucius", "Cong", "Deshi", "Dewei", "Fo-hai", "Fo-hsing", "Gan", "Gao", "Genjo", "Ho", "Hsin", "Huang fu", "Hui-chao", "HuiK", "Jiang", "Jin", "Jing", "Jun", "Kong", "Lao-Tzu", "Lee", "Lei", "Li", "Li-Liang", "Liang", "Liko", "Manchu", "Ming", "Niao-ka", "On", "Qing-Nan", "Quon", "Shen", "Shing", "Sun", "Tung", "Uang", "Wang", "Wen", "Woo", "Wu-pen", "Xi-Wang", "Xiaoping", "Xin", "Xing-fu", "Yao", "Ye", "Yo", "Yong", "Yu", "Yuan", "Zhong", "Zhu", "Zhuang"
    };
...
string* MaleNameGiven::czechGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Bedrich", "Cerny", "Damek", "Karel", "Kliment", "Ladislav", "Libor", "Ludomir", "Oldrich", "Radek", "Radoslav", "Rehor", "Strom", "Vasil", "Vavrin", "Vavrinec", "Veleslav", "Venec", "Vila", "Vladislav", "Vojtech", "Zdenek", "Zitomer"
    };
...
string* MaleNameGiven::danishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Bartram", "Diederik", "Gardiner", "Hobart", "Ib", "Nils", "Soren"
    };
...
string* MaleNameGiven::dutchGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Hodding", "Kyler", "Maarten", "Rembrandt", "Rodolf", "Roosevelt", "Schuyler", "Sklaer", "Van", "Vandyke", "Wagner", "Zeeman"
    };
...
string* MaleNameGiven::egyptianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Imhotep", "Paki", "Rahotep", "Zahur"
    };
...
string* MaleNameGiven::finnishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Juhani", "Jussi", "Kevat", "Miko", "Mustanen", "Vaino"
    };
...
string* MaleNameGiven::gaelicGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Alan", "Angus", "Blaan", "Conan", "Fagan", "Kade", "Keefe", "Keegan", "Keeland", "Keenan", "Kennedy", "Kenyon", "Kermit", "Kern", "Kerry", "Kevin", "Kieran", "Kinnel", "Lawler", "Lee", "Lennon", "Lon", "Mackenzie", "Neal", "Parlan", "Phelan", "Regan", "Renny", "Riley", "Riordan", "Rogan", "Rooney", "Rory", "Ryan", "Seamus", "Senach", "Sheehan", "Slevin", "Sloan", "Sullivan", "Sully", "Sweeny", "Tee"
    };
...
string* MaleNameGiven::hawaiianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Akamu", "Analu", "Aulii", "Bane", "Eowyn", "Havika", "Kahale", "Kahanu", "Kahoku", "Kaholo", "Kai", "Kaikeapona", "Kaipo", "Kalama", "Kale", "Kalei", "Kaleo", "Kalepa", "Kana", "Kane", "Kanoa", "Kapono", "Keahi", "Keanu", "Kekoa", "Kelii", "Keona", "Kepano", "Konala", "Laakea", "Laionela", "Loe", "Lono", "Lulani", "Maik", "Makaio", "Makan", "Malo", "Manu", "Mauli", "Meka", "Moke", "Nahele", "Nalani", "Okalani", "Oke", "Okelani", "Oliana", "Onaona", "Palani", "Pekelo", "Uleki"
    };
...
string* MaleNameGiven::indianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Kers", "Mog", "Omprakash", "Prabodh", "Praful", "Som"
    };
...
string* MaleNameGiven::koreanGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Daeshim", "Jintao", "Seung", "Yong-Sun", "Young-Ja", "Young-Jae"
    };
...
string* MaleNameGiven::middleEnglishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Alden", "Alder", "Crockett", "Kemp", "Kipling", "Ladd", "Lander", "Lane", "Latimer", "Lyman", "Macon", "Mendel", "Mercer", "Mull", "Nye", "Perry", "Prentice", "Reeve", "Sanders", "Sawyer", "Skeet", "Sterne", "Swain", "Taylor", "Tennyson", "Todd", "Trey", "Tucker", "Turner", "Twain", "Tyler", "Vance", "Vane", "Wade", "Walker", "Yates"
    };
...
string* MaleNameGiven::norseGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Balder", "Dana", "Freyr", "Gareth", "Haldor", "Hardicanute", "Hogarth", "Holm", "Hsin", "Hume", "Kelby", "Ker", "Lamont", "Magne", "Oda", "Oddvar", "Odin", "Ove", "Quimby", "Ragnar", "Sutherland", "Terje", "Thurston", "Ulfred", "Unni", "Volund", "Yongvar"
    };
...
string* MaleNameGiven::oldFrenchGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Anicetus", "Bassett", "Bayard", "Bellamy", "Boden", "Borden", "Boswell", "Brigham", "Cable", "Chancellor", "Channing", "Chase", "Chivalry", "Corbin", "Curtis", "Darrell", "Flannery", "Fletcher", "Forrest", "Foster", "Francis", "Franklin", "Jay", "Jeffrey", "Justin", "Leroy", "Lyle", "Macy", "Marlon", "Maslin", "Oriel", "Percival", "Prewitt", "Quennel", "Roy", "Telo"
    };
...
string* MaleNameGiven::oldGermanGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Adalbert", "Adalgiso", "Adelbert", "Adelfried", "Adelino", "Adelmio", "Adelmo", "Ademaro", "Ahren", "Aksel", "Alfonso", "Alice", "Aloysius", "Anselm", "Blaz", "Carl", "Carolus", "Conrad", "Engelbert", "Ernest", "Hamlet", "Harold", "Harvey", "Jarvis", "Leopold", "Orlantha"
    };
...
string* MaleNameGiven::oldNorseGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Alvis", "Borg", "Gunnar", "Harper", "Kirk", "Leif", "Njord", "Olaf", "Oliver", "Oscar", "Ronald", "Roscoe", "Sigurd", "Sindri", "Skipp", "Thor", "Turpin"
    };
...
string* MaleNameGiven::persianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Abtin", "Ardalan", "Atash", "Azar", "Bahram", "Behdad", "Behruz", "Bijan", "Borna", "Caspar", "Cyrus", "Dareh", "Darius", "Davood", "Eskander", "Fazel", "Firouz", "Gaspar", "Kaspar", "Kaveh", "Khorshed", "Khortdad", "Murdad", "Nard", "Persepolis", "Rashne", "Ruhollah", "Sarosh", "Siamak", "Xerxes"
    };
...
string* MaleNameGiven::polishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Cerek", "Dobry", "Gerik", "Jacek", "Jarek", "Lech", "Ludoslaw", "Magnar", "Mandek", "Marcin", "Marek", "Nelek", "Olesia", "Ryzard", "Tanek", "Urjasz", "Waclaw", "Walenty", "Wlod", "Wojtek", "Zarek", "Zygmunt"
    };
...
string* MaleNameGiven::polynesianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Kalani", "Lauaki", "Lisiate", "Uhila", "Ulani", "Vala", "Valu", "Vea"
    };
...
string* MaleNameGiven::russianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Boris", "Dobry", "Dusan", "Egor", "Feodore", "Fyodor", "Gavrie", "Gleb", "Ivan", "Konstantin", "Kostas", "Kostya", "Lesta", "Magar", "Maksim", "Mikhail", "Miloslav", "Nikhil", "Oksana", "Olga", "Sacha", "Sarkis", "Semyon", "Sergei", "Timur", "Ulan", "Ustin", "Vadim", "Valeri", "Valerian", "Vanya", "Venedict", "Vladilen", "Vlas", "Wassily", "Xenik", "Yerik", "Yevgeni", "Yurchik", "Yuri"
    };
...
string* MaleNameGiven::sanskritGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Arjun", "Jackal", "Jafar", "Krishna", "Kumar", "Mahatma", "Nanda", "Nataraj", "Rajiv", "Uttam", "Vasu", "Veda", "Yogi"
    };
...
string* MaleNameGiven::scandinavianGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Amund", "Arvid", "Bjorn", "Canute", "Carolus", "Carson", "Dag", "Davin", "Denholm", "Dyre", "Egil", "Elvis", "Eric", "Filip", "Fortinbras", "Frey", "Haakon", "Hannes", "Igor", "Ingmar", "Ingvar", "Jarl", "Kaj", "Karr", "Kelsey", "Kerr", "Kettil", "Knute", "Kolby", "Lars", "Ludvig", "Lunt", "Mats", "Nels", "Niels", "Norb", "Odell", "Odo", "Olan", "Pal", "Quinby", "Rad", "Rune", "Skjøld", "Snorre", "Steinar", "Stieran", "Sven", "Sølve", "Thiassi", "Thoralf", "Thorin", "Thorstein", "Toste", "Tryggvi", "Ulffr", "Ulick", "Ull", "Ulrik", "Ulster", "Ultar", "Vali", "Vannevar", "Vanslow", "Vidar", "Vidkun", "Viggo", "Viljalmr", "Viljo", "Von", "Waage", "Wray", "Zvi"
    };
...
string* MaleNameGiven::slavicGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Casimir", "Duscha", "Evzen", "Gavril", "Ilie", "Jan", "Kostya", "Ludovic", "Marót", "Melik", "Mete", "Miroslav", "Mladen", "Oleg", "Ondrea", "Pavel", "Pavlos", "Pavo", "Peja", "Polixenes", "Polk", "Radman", "Reza", "Vaclav", "Vas", "Vencel", "Vlade", "Vladimir", "Volya", "Wenceslaus", "Wieslav", "Ziven", "Zorro", "Zorya", "Zydrunas"
    };
...
string* MaleNameGiven::swahiliGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Jabari", "Jelani", "Khairi", "Rashid"
    };
...
string* MaleNameGiven::swedishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Anderson", "Axel", "Balder", "Beck", "Burr", "Fiske", "Gustave", "Per", "Staffan"
    };
...
string* MaleNameGiven::teutonicGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Kem", "Orinda", "Paxton", "Raeburn", "Renard", "Roald", "Sigfried", "Sigmund", "Stewart", "Theodoric", "Thierry", "Thurborn", "Udo", "Uland", "Ulf", "Walden", "Waldo", "Wendell", "Werner", "Wilbur", "Willard", "William", "Wolfgang", "Wolfram", "Yves"
    };
...
string* MaleNameGiven::turkishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Berk", "Muzaffer", "Nedim", "Nesim", "Nesip", "Okan", "Olcay", "Onan", "Ozan", "Ozaner", "Sadi", "Safak", "Selim", "Semih", "Sencer", "Sevilin", "Sinan", "Taner", "Tarkan", "Tecer", "Tercan", "Tezer", "Tuncer", "Ufuk", "Ugur", "Ulucan", "Yigit", "Yucel", "Zafer", "Zeki", "Zeren"
    };
...
string* MaleNameGiven::vietnameseGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Chung", "Dong", "Duy", "Gan", "Keemo", "Lam", "Laman", "Long", "Phuoc", "Phuong", "Quan", "Quan Van", "Quang Tu", "Ritchell", "So", "Tai", "Thai", "Thong", "Tinh", "Tong", "Viet", "Vui", "Yen"
    };
...
string* MaleNameGiven::welshGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Arthur", "Avon", "Baden", "Barry", "Bowen", "Bronwen", "Cade", "Cedric", "Clyde", "Conway", "Denzel", "Deverell", "Dewey", "Drew", "Dylan", "Emrick", "Floyd", "Fluellen", "Gavin", "Gawain", "Griffin", "Griffith", "Idris", "Kai", "Karey", "Kay", "Keith", "Kenn", "Kenrich", "Mabon", "Main", "Olwen", "Parry", "Pembroke", "Reese", "Rondell", "Sayer", "Sonnagh", "Tathal", "Tathan", "Teulyddog", "Tewdwr", "Trahaearn", "Tudfwlch", "Tudur", "Wren", "Ysgarran"
    };
...
string* MaleNameGiven::yiddishGivenNamesMale(int count) const
{
    string* randomNames = new string[count];

    string names[] = { "Gershon", "Lantz", "Zaide", "Zalman", "Zindel"
    };
...
string* MaleNameGiven::getFirstName(int select, int count) const
{
